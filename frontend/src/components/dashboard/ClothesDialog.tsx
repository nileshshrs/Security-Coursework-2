...
export default function ClothesDialog({
    open,
    onOpenChange,
}: ClothesDialogProps) {
    ...
    const onSubmit = (data: ClothesSchemaInput) => {
        ...
        createClothesMutation.mutate(
            ...
            },
            {
                ...
                onError: () => {
                    toast.error("Failed to create clothing item.");
                },
            }
        );
    };
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-lg w-full p-6">
                <DialogHeader>
                    <DialogTitle>Add New Clothing Product</DialogTitle>
                </DialogHeader>
                    ...
                    <DialogFooter className="mt-4">
                        <Button
                            ...
                            disabled={
                                ...
                                createClothesMutation.status === "pending"
                            }
                        >
                            {uploadImageMutation.status === "pending" ||
                                createClothesMutation.status === "pending"
